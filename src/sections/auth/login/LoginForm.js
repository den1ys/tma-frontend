...
export default function LoginForm() {
  ...
  const onSubmitGenerarUsuario = async (event) => {
    ...
    try {
      ...
      const response = await fetch("https://fichaonline.sacooliveros.edu.pe:4010/api/auth/generar_usuario", { headers: { "Content-Type": "application/json" }, method: "POST", body: entrada });
